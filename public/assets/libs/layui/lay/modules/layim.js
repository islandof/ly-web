...
layui.define(["layer", "laytpl", "upload"], function (i) {
    ...
    var x, b, w, k, C, S = function (i, a, n) {
        ...
        Z = function () {
            ...
            var mscr = document.getElementById("layim-chat-main");
            if (mscr != null) {
                mscr.onscroll = function (e) {
                    mch = mscr.scrollTop
                }
            }

            //不自动滚动
            if (a[0].scrollHeight - mch < 400 || mch == 0) {
